...
set(CMAKE_C_FLAGS "${ARCH_COMMON_FLAGS_STR} ${ARCH_NO_AUTOVEC_FLAGS_STR} ${CMAKE_C_FLAGS}")
set(CMAKE_CXX_FLAGS "${ARCH_COMMON_FLAGS_STR} ${ARCH_NO_AUTOVEC_FLAGS_STR} ${CMAKE_CXX_FLAGS}")
set(CMAKE_ASM_FLAGS "${ARCH_COMMON_FLAGS_STR} ${CMAKE_ASM_FLAGS}")
set(CMAKE_SHARED_LINKER_FLAGS "${ARCH_COMMON_FLAGS_STR} -fuse-ld=lld -nostdlib ${CMAKE_SHARED_LINKER_FLAGS}")
