use alloc::sync::Arc;
use alloc::vec::Vec;
use ext4_rs::Ext4DirEntry;
use ext4_rs::Ext4DirSearchResult;
...
impl Ext4Inode {
    pub fn new(sno: u32, ino: u32, superblock: &Arc<SuperBlockInner>) -> Self {
        ...
        // let inode_ref = MaybeUninit::uninit();
        Self {
            ino,
            sno,
...
impl InodeOps for Ext4Inode {
    ...
    fn fstat(&self) -> SysResult<FileStat> {
        let inode_ref = self.superblock.get_inode_ref(self.ino);
        ...
        kstat.st_ino = self.ino as u64;
        kstat.st_size = inode_ref.inode.size() as i64;
        kstat.st_nlink = inode_ref.inode.links_count() as u32;
        kstat.st_mode = inode_ref.inode.mode() as u32;
        // kstat.st_atime_sec = inode_ref.inode.atime() as i64;
        // kstat.st_atime_nsec = 0;
        // kstat.st_mtime_sec = inode_ref.inode.mtime() as i64;
        // kstat.st_mtime_nsec = 0;
        // kstat.st_ctime_sec = inode_ref.inode.ctime() as i64;
        // kstat.st_ctime_nsec = 0;
