...
pub use sys::{
    PidMaxInode, PipeMaxSizeInode, PipeUserPagesSoftInode, ShmMaxInode, SysDirInode, SysFsDirInode, SysKernelDirInode,
    TaintedInode,
};
pub use task::{
    ...
    F: Fn(T::Item) -> SysResult<String>,
{
    ...
    for item in iterator {
        ...
        buf[copied..copied + to_copy].copy_from_slice(&line_bytes[start_in_line..start_in_line + to_copy]);
        copied += to_copy;
        pos += line_len;
